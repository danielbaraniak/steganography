...
def embed_batch():
    ...
    Path(output_dir / "original_1440").mkdir(parents=True, exist_ok=True)
    Path(output_dir / "stego_1440").mkdir(parents=True, exist_ok=True)
    ...
    for i, file_name in enumerate(file_names):
        ...
        for ext in ["jpg", "png"]:
            ...
            output_original_path = output_dir / "original_1440" / info["file_name_new"]
            output_stego_path = output_dir / "stego_1440" / info["file_name_new"]
    ...
    utils.save_data_to_csv(measurements, str(output_dir / "metadata_1440.csv"))
