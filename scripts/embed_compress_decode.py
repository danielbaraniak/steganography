...
def main():
    ...
    for ecc_symbols, level, block_size, color_space, use_channels, file_name in itertools.product(
            [1, 5, 12], [3, 4, 5], [3, 5], ["RGB", "YCrCb"], [[0], [1], [2], [0, 1, 2]], file_names
    ):
        custom_config = {
    ...
    # for ecc_symbols, level, file_name in itertools.product([5], [4], file_names):
    #     custom_config = {
    #         "ecc_symbols": ecc_symbols,
    #         "level": level,
    #     }
